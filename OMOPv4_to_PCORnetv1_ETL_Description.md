<h1>Overview</h1>
This document describes the ETL specifications/conventions that enable data stored in the [OMOP CDM v5.2] (http://omop.org/CDM) model to be mapped to the [PCORnet V3.1](http://pcornet.org/) model. In particular, this document describes the business logic corresponding to the ETL code in the OMOP-PCORNetr.sql file. In this process, we assume that an OMOP CDM v5.2 instance is already available for transformation to the PCORnet model instance. 
